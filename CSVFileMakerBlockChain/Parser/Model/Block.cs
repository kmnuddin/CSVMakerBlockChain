...
namespace CSVFileMakerBlockChain.Parser.Model
{
    public class Block : IBlock
    {
        ...
        public Block(string n_trans, string output_Total, string estimated_Transaction_Volume, string transaction_Fees, string timestamp, string received_Time, string relayed_By, string difficulty, string bits, string size, string weight, string version, string nonce, string block_Reward, IBlockHeight height)
        {
